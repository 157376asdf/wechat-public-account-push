export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wxb71e624165c3de68",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "7d0c0eeebd4737ab8014eb4660fa2df5",
   ...
   *    // 你想对他发送的模板消息的模板ID
   *    useTemplateId: "gxex9CImni1z0qj1GHWxqjG6fCfJ_EeSKdvIRRXLlo8",
   *    // 他点击详情后跳转的页面,你可以设置成微博的热榜，也可以设置成其他，网址一定要填对；不填对也没关系，随便你，会打不开而已。
   *    openUrl: "https://wangxinleo.cn"
   *   }, 
   * ]
   */
  USERS: ["oQgL55ww-3yzuAtpld1pg3BDdrvA"]
    {
      // 想要发送的人的名字
      name: "霞霞要努力",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
